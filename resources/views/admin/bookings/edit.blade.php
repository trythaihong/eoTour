...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Edit Booking #{{ $booking->id }}</h4>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('people_count') is-invalid @enderror" 
                                   ...
                                   value="{{ old('people_count', $booking->people_count) }}" min="1" required>
                            @error('people_count')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <h5 id="tour-price">${{ number_format($booking->tour->price, 2) }}</h5>
                                    </div>
                                    <div class="col-6">
                                        <small>Total Price:</small>
                                        <h5 id="total-price">${{ number_format($booking->total_price, 2) }}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-2">
                                        ...
                                        <strong>Created:</strong> {{ $booking->created_at->format('M d, Y h:i A') }}
                                    </li>
                                    <li class="mb-2">
...
<script>
    function calculateTotalPrice() {
        ...
        if (selectedOption && selectedOption.value) {
            const tourPrice = parseFloat(selectedOption.getAttribute('data-price')) || {{ $booking->tour->price }};
